...
export default function ServicesPage() {
  return (
    ...
    >
      ...
      >
           <div className="max-w-7xl mx-auto px-6 text-center py-16 bg-gradient-to-b from-cyan-700 to-cyan-600 text-white">
      <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-200 mb-12">
