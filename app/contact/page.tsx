...
export default function ContactPage() {
  ...
  return (
    ...
    >
      ...
      <motion.section
      className="py-16 bg-gradient-to-r from-teal-600 to-blue-800 text-white"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
      variants={{
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl font-extrabold mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-blue-400">
          Contact Us
        </h2>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="relative">
            <input
              ...
              required
              className="block w-full px-6 py-4 bg-gray-200 text-gray-800 placeholder-gray-500 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-teal-400 transition duration-200 ease-in-out"
          ...
          <div className="relative">
            <button
              type="submit"
              className="w-full py-4 bg-teal-700 text-white font-semibold rounded-lg shadow-md hover:bg-teal-800 transition duration-300 ease-in-out"
            >
