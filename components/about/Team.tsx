  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl text-cyan-900 font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-200">
          Meet Our Team
        </h2>
          ...
          <div className="whitespace-nowrap animate-marquee">
            ...
            >
              <img
                src="/shanta.png"
                alt="Shanta Kunwar"
                className="w-40 h-40 rounded-full border-4 border-cyan-600 mb-4 mx-auto shadow-xl transition-shadow duration-300 hover:shadow-2xl"
              />
              <h3 className="text-xl font-semibold text-cyan-700">Shanta Kunwar</h3>
